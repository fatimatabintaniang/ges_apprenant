    ...
    <div class="p-6 overflow-y-auto h-[80vh] -mt-10">
        <div class="p-6 bg-[#F9EFEF] rounded-xl">
            ...
            <div class="flex justify-between items-center mb-4">
                ...
                <a href="?controllers=referentiel&page=listeReferentiel&search=<?= $_GET['search'] ?? '' ?>&showModal=1" class="bg-orange-500 text-white px-4 py-2 rounded-lg flex items-center gap-2 hover:bg-orange-600 transition">
                        ...
                        <div class="p-4">
                            ...
                            <h3 class="text-sm">Capacite: <?= htmlspecialchars($referentiel['capacite']) ?> places</h3>
                                <div class="flex justify-between mt-4">
                                    ...
                                    <a href="?controllers=referentiel&page=confirmAnnulerRef&referentiel_id=<?= $referentiel['id_referentiel'] ?>"
...
<div id="addPromotionModal" class="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 
    ...
    <div class="bg-white rounded-lg w-full max-w-md mx-4">
        <div class="flex justify-between items-center border-b p-4">
            ...
            <a href="?controllers=referentiel&page=listeReferentiel&search=<?= $_GET['search'] ?? '' ?>" class="text-gray-500 hover:text-gray-700">
        ...
        <form method="post" action="?controllers=referentiel&page=<?= isset($_GET['action']) && $_GET['action'] == 'edit' ? 'updateReferentiel' : 'addReferentiel' ?>" class="p-6">
            ...
            <div class="mb-4">
                ...
                <input type="text" name="libelle" id="referentielName" 
                    value="<?= htmlspecialchars($referentielToEdit['libelle'] ?? $old['libelle'] ?? '') ?>"
                ...
                <div class="mb-4">
                    ...
                    <input type="url" name="image" id="referentielImage" value="<?= htmlspecialchars($old['image'] ?? '') ?>"
                        class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-orange-400"
                ...
                <div class="mb-4">
                    ...
                    <textarea name="description" id="referentielDescription" value=""
                        class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-orange-400"><?= htmlspecialchars($old['description'] ?? '') ?></textarea>
                ...
                <div class="grid grid-cols-2 gap-3">
                    <div>
                        ...
                        <input type="number" name="capacite" id="referentielCapacite" value="<?= htmlspecialchars($old['capacite'] ?? '') ?>"
                            class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-orange-400">
                    ...
                    <div>
                        ...
                        <input type="text" name="session" id="referentielSession" value="<?= htmlspecialchars($old['session'] ?? '') ?>"
                            class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-orange-400">
